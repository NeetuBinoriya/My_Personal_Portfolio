...
const Contact = () => {
    ...
    const onSubmit = async (event) => {
        ...
        formData.append("access_key", "6fe2568a-eaf1-472d-8485-d99951546638");
        ...
        <div className="contact-section">
            <div className="contact-left">
                ...
                <div className="contact-details">
                    ...
                    <img src={mail_icon} alt="" /> <p>neetu.binoriya@gmail.com</p>
                    </div>
                    <div className="contact-detail"> 
                    <img src={call_icon} alt="" /> <p>+91 8349649222</p>
                    </div>
                    <div className="contact-detail"> 
                    <img src={location_icon} alt="" /> <p>Indore,(M.P.) India</p>
                    </div>
                </div>
            </div>
